...
public class Menu {
    ...
    public Menu() {
        ...
        items.put("salad_caprese", new Salad("Caprese Salad", 7.00));
        items.put("salad_italian", new Salad("Italian Salad", 6.70));
        ...
        items.put("sandwich_grilledcheese", new Sandwich("Grilled Cheese Sandwich", 9.00));
        items.put("sandwich_pastrami", new Sandwich("Pastrami Sandwich", 11.50));
        ...
        items.put("drink_milk", new Drink("Milk", 3.00));
        items.put("drink_coffee", new Drink("Coffee", 2.50));
    }
