...
public class App {
    ...
    public static void main(String[] args) {
        ...
        get("/", (req, res) -> {
            ...
            html += "<option value='salad_caprese'>Caprese Salad ($7.00)</option>";
            html += "<option value='salad_italian'>Italian Salad ($6.70)</option>";
            ...
            html += "<option value='sandwich_grilledcheese'>Grilled Cheese Sandwich ($9.00)</option>";
            html += "<option value='sandwich_pastrami'>Pastrami Sandwich ($11.50)</option>";
        ...
        get("/order", (req, res) -> {
            ...
            if (total > 20.00) {
                html += "<p><b>Total Charge:</b> " + money(total * 0.9) + "</p>";
            }
            else {
